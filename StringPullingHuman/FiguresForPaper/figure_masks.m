...
for ii = 1:length(frameNums)
    masks.Im = get_masks(handles,frameNums(ii),1);
    masks.Ie = get_masks(handles,frameNums(ii),2);
    masks.Ih = get_masks(handles,frameNums(ii),3);
    masks.In = get_masks(handles,frameNums(ii),4);
    masks.Is = get_masks(handles,frameNums(ii),5);
    aoMasks{ii} = masks;
end
