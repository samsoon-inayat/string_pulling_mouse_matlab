function [choise] = bttnChoiceDialog(dlgOptions, dlgTitle, defOption, qStr, bttnsOredring,Pos)
%% bttnChoiseDialog
...
menuFigH=figure('Units', 'normalized', 'Position', [.5, .5, .1, .1], 'MenuBar', 'none',...
   'NumberTitle', 'off', 'Name', dlgTitle, 'CloseRequestFcn', 'uiresume(gcbf)','windowStyle','modal'); 
