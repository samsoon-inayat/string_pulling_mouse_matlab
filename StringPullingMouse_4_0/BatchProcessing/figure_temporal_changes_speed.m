...
% p(5) = 0.0044; p(1) = 0.004748; p(6) = 0.007195;
...
runthis = 0;
if runthis
varName = 'HFD.motion.ent'; varNameT = 'ENT';
% out = get_masked_values(ent_b,ent_w,varName,ds_b,ds_w,0.01)
outp = get_masked_values_h(ent_bp,ent_wp,varName,ds_bp,ds_wp,0.01);
outr = get_masked_values_h(ent_br,ent_wr,varName,ds_br,ds_wr,0.01);
